...
if(typeof query==='string'&&/[\uAC00-\uD7A3\u3131-\u318E\u314F-\u3163]/.test(query)){var _koId=query.toLowerCase().replace(/[^a-z0-9\uAC00-\uD7A3\u3131-\u318E\u314F-\u3163]+/g,'');if(window.BattleAliases&&window.BattleAliases[_koId])query=window.BattleAliases[_koId];}
query=toID(query);
...
if(type==='move'){var _mv=entry[1];if(typeof _mv==='string'&&/[\uAC00-\uD7A3\u3131-\u318E\u314F-\u3163]/.test(_mv)){var _mvKoId=_mv.toLowerCase().replace(/[^a-z0-9\uAC00-\uD7A3\u3131-\u318E\u314F-\u3163]+/g,'');if(window.BattleAliases&&window.BattleAliases[_mvKoId])_mv=window.BattleAliases[_mvKoId];}entry[1]=toID(_mv);}
if(type==='ability'){var _ab=this.dex.abilities.get(entry[1]);entry[1]=_ab.englishName||_ab.name;}
if(type==='tier'){
