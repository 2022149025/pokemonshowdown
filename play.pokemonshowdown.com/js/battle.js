...
var _remMove=Dex.moves.get(moveName);moveName=_remMove.name;
if(moveName.startsWith('*'))return;
if(_remMove.id==='struggle')return;
...
}else if((move.englishName||move.name).startsWith('Z-')){
moveName=(move.englishName||moveName).slice(2);
