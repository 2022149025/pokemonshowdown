...
var _resolveAbilId=function(name){return toID(window.resolveKoreanName?window.resolveKoreanName(name):name);};
if(species.isMega){
abilitySet.unshift(['html',"Will be <strong>"+species.abilities['0']+"</strong> after Mega Evolving."]);
species=dex.species.get(species.baseSpecies);
}
abilitySet.push(['ability',_resolveAbilId(species.abilities['0'])]);
if(species.abilities['1']){
abilitySet.push(['ability',_resolveAbilId(species.abilities['1'])]);
}
if(species.abilities['H']){
abilitySet.push(['header',"Hidden Ability"]);
abilitySet.push(['ability',_resolveAbilId(species.abilities['H'])]);
}
if(species.abilities['S']){
abilitySet.push(['header',"Special Event Ability"]);
abilitySet.push(['ability',_resolveAbilId(species.abilities['S'])]);
}
